...
@Component({
    selector:'app-registrar-registro-tecnico',
    templateUrl:'./registrar-registro-tecnico.component.html',
    styleUrls: ['./registrar-registro-tecnico.component.scss']
})

export class RegistrarRegistroTecnicoComponent implements OnInit{
  motivo = [
    {
        mot:'Motivo',
    },
  ...
  ngOnInit(){
    ...
    this.formReporteT = new FormGroup({
        ...
        'estadomaquina':new FormControl('Estado',Validators.required),
