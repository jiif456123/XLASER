...
@Component({
    selector:'app-actualizar-reporte-seguimiento',
    templateUrl:'./actualizar-reporte-seguimiento.component.html',
    styleUrls: ['./actualizar-reporte-seguimiento.component.scss']
})

export class ActualizarReporteSeguimientoComponent implements OnInit{
    codigo = [
        {
          cod:'ADVANCE 8786I',
        },
